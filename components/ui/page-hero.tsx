...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-line/70 bg-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(217,70,32,0.05),transparent_24rem)]" aria-hidden="true" />
        ...
        <div className="hero-panel px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
          <div className="relative grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            ...
            <div className="hero-in space-y-4 [--delay:320ms]">
              ...
              <div className="rounded-[1.5rem] border border-line/70 bg-canvas/75 px-5 py-5">
                ...
                <div className="mt-4 rounded-[1.2rem] border border-white/70 bg-white/80 px-4 py-3 text-xs leading-5 text-slate">
