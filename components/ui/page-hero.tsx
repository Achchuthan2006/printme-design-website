...
const featureChips = [
  "Local Scarborough shop",
  "File review before print",
  "Help available for custom jobs",
];
  ...
  return (
    <section className="relative overflow-hidden border-b border-black/5 bg-white/60">
      ...
      <div className="container-shell section-space relative">
        <Card variant="panel" className="px-6 py-8 sm:px-8 lg:px-10 lg:py-11">
            ...
            <div className="hero-in space-y-4 [--delay:320ms]">
              <div className="grid gap-3">
                {highlights.map((item, index) => (
                  <Card key={item} variant="surface" className="signal-card px-4 py-4">
              ...
              <Card variant="glass" className="px-5 py-5">
                ...
                <Card variant="ghost" className="mt-4 rounded-[1.25rem] border-white/80 bg-white/78 px-4 py-3 text-xs leading-5 text-slate shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
