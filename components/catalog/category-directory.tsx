      ...
      {productCategories.map((category) => {
        ...
        return (
          <Link
            ...
            className="premium-card group overflow-hidden rounded-[1.7rem] border border-line/70 bg-white p-5 shadow-soft transition hover:-translate-y-0.5 hover:border-brand/18 hover:shadow-card"
          >
            <div className="flex items-start justify-between gap-4">
              <span className="flex h-12 w-12 items-center justify-center rounded-[1rem] border border-line/70 bg-canvas text-brand">
            ...
            <p className="mt-6 text-[10px] font-extrabold uppercase tracking-[0.22em] text-slate">{category.shortTitle}</p>
            <h3 className="mt-2 font-display text-[1.55rem] leading-[1.02] text-ink">{category.title}</h3>
            <p className="mt-3 text-sm leading-6 text-slate">{category.description}</p>
            <div className="mt-5 rounded-[1.2rem] border border-line bg-canvas/55 p-4 text-xs leading-5 text-slate">
            ...
            {category.subcategoryGroups?.length ? (
              <div className="mt-4 rounded-[1.2rem] border border-line bg-white p-3 text-xs leading-5 text-slate">
            ...
            <div className="mt-5 flex items-center justify-between border-t border-line/75 pt-4">
