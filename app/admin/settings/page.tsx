...
export default function AdminSettingsPage() {
  const settings = [
    ...
    ["Admin basic auth user", "ADMIN_PORTAL_USERNAME"],
    ["Admin basic auth pass", "ADMIN_PORTAL_PASSWORD"],
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_0.8fr]">
        ...
        <AdminCard>
          ...
          <ul className="mt-5 space-y-3 text-sm leading-6 text-slate">
            <li className="rounded-xl border border-line bg-white p-3">Current state: the admin portal is now expected to sit behind both HTTP basic auth at the edge and the internal staff allowlist in the app shell.</li>
            <li className="rounded-xl border border-line bg-white p-3">Next security step: replace the temporary allowlist model with Supabase RLS, admin role claims, and first-class server-side session enforcement.</li>
