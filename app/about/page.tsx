        ...
        <div className="container-shell">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="surface-card p-8">
              <p className="text-sm font-bold uppercase tracking-[0.22em] text-brand">{siteConfig.tagline}</p>
              <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-ink">Modern service built on real printing experience</h2>
